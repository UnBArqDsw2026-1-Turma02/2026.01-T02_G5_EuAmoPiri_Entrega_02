...
<center>Figura 3 — Avaliação dos revisores</center>
...
<center>Figura 4 — Versão 1.0 sem alterações - Visualizar Dashboard </center>

### Versão com correções

![Diagrama de Estados do Perfil do Usuário](./imagens/visualizar_dashboard_1.1.png)
<center>Figura 5 — Versão 1.1 com alterações propostas por Anna - Visualizar Dashboard </center>
...
<center>Figura 6 — Versão 1.0 sem alterações - Cadastrar Local </center>

### Versão com correções

![Diagrama de Estados do Perfil do Usuário](./imagens/cadastrar_local_1.1.png)
<center>Figura 7 — Versão 1.1 com alterações propostas por Anna - Cadastrar Local </center>
...
<center>Figura 8 — Versão 1.0 sem alterações - Visualizar Relatos e Locais</center>

### Versão com correções

![Diagrama de Estados do Perfil do Usuário](./imagens/locais_relatos_1.1.png)
<center>Figura 9 — Versão 1.1 com alterações propostas por Anna - Visualizar Relatos e Locais </center>
...
| 24/04/2026 | `1.1`  | Adicionando especificação de participantes em cada interface | [Milena](https://github.com/milenamso) <br> [Amanda](https://github.com/AmandaaMoura) <br> [Gabriela](https://github.com/gabrieladouradof) | [Anna](https://github.com/annacbrandao)  <br>[Eduardo](https://github.com/eduardodpms)<br>[Mariana](https://github.com/Marianamrts) <br>  [Leticia](https://github.com/leticiakrpaiva) | 
