...
Davi, Gabriela e Letícia usaram o Discord assincronamente para a confecção do artefato. Houve discussões internas sobre alguns pontos a se seguir e feedbacks também!
...
Esses feedbacks geraram a versão 1.4!
...
Davi: Faltava um gateway que abordasse e filtrasse os comentários que eventualmente fossem denunciados. 
...
| 20/04/2026 | `1.3`  | Colocação do registro da denúncia como dado salvo antes de finalizar                          | [Davi](https://github.com/daviegito)              | [Anna](https://github.com/annacbrandao) e [Milena](https://github.com/milenamso) |

## Histórico do documento
| Data       | Versão | Descrição                                               | Autor                                                      | Revisores                                                                              |
| ---------- | ------ | ------------------------------------------------------- | ---------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| 21/04/2026 | `1.0`  | Criação do documento                           | [Davi do Egito](https://github.com/daviegito)              | ---------    
| 21/04/2026 | `1.1`  | Acréscimo de mais evidências pra rastreabilidade                | [Davi do Egito](https://github.com/daviegito)              | ---------    