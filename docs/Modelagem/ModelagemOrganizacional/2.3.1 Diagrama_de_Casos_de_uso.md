...
_Figura 1 - Discussão assíncrona no Discord_
...
_Figura 2: Discussão no Discord — dependência entre denúncia, local e relatos_
...
_Figura 3: Discussão no Discord — acesso ao relato via local_
...
_Figura 4: Discussão no Discord — extend e include na denúncia_
...
_Figura 5: Feedback da revisora Milena no Discord_
...
_Figura 6: Feedback da revisora Anna no Discord_
...
_Figura 7 - Diagrama de Casos de Uso com atores_
...
_Figura 8 - Diagrama com Casos de Uso_
...
_Figura 9 - Diagrama com Associações_
...
_Figura 10 - Diagrama com mais associações e dependências_
...
_Figura 12 - Diagrama extra feito por João Victor_

![Versão "João"](./imagens/caso_de_uso_v_joao.png)

João Victor: Nesta versão tentei desenvolver o máximo que pude com os meus conhecimentos e estudos sobre os diagramas de casos de uso. Apesar da dificuldade que tive em confeccioná-lo, o processo de elaboração e o material de estudo foram de grande ajuda, reforçando o aprendizado e trazendo uma visão mais clara sobre as relações do sistema com as personas.

Fonte: DrawIo

### Link para o Draw.io

Clique [aqui](https://drive.google.com/file/d/1dwZfImVYyGQS4AvW0gBqt4vY69LmWkAC/view) para acessar o diagrama.
...
Eduardo: Um diagrama de fácil compreensão e elaboração, mas de extrema importância para comunicar os requisitos funcionais de um sistema sob a perspectiva do usuário final. Mas sempre é preciso estudar e revisar conceitos para uma melhor elaboração.
...
2. VISUAL PARADIGM. What is Use Case Diagram? Disponível em: <https://www.visual-paradigm.com/guide/uml-unified-modeling-language/what-is-use-case-diagram/>. Acesso em: 24 abr. 2026.
...
| 22/04/2026 | `1.1`                   | Inserção de ações do diagrama de atividades e lembrete de boas práticas no diagrama de casos de uso                      | [Davi do Egito](https://github.com/daviegito)              |                                                                                                   |
...
| 24/04/2026 | `1.0 Visão João Victor` | Versão inicial do diagrama                                                                                               | [João Victor](https://github.com/Chaotzuu)                 | [Mariana Martins](https://github.com/Marianamrts) e [Davi do Egito](https://github.com/daviegito) |
...
| 24/04/2026 | `1.5`  | Conserto de comentário da visão e acréscimo de histórico do artefato                                                             | [Davi do Egito](https://github.com/daviegito)              |
| 24/04/2026 | `1.6`  | Adição da versão extra do diagrama                                                                                               | [João Victor](https://github.com/Chaotzuu)                 | [Mariana](https://github.com/Marianamrts) |
