...
*Figura 12 - Diagrama extra feito por João Victor*
...
Eduardo: um diagrama simples de entender e de construir, mas muito importante para mostrar como o sistema funciona do ponto de vista do usuário. Ele ajuda a visualizar o que cada tipo de usuário pode fazer dentro do sistema e como essas interações acontecem. Mesmo sendo mais direto, ainda exige atenção aos conceitos e uma boa revisão para garantir que tudo esteja bem representado.
...
| 24/04/2026 | `1.7`  | Adição da visão do Eduardo | [Davi do Egito](https://github.com/daviegito) | [Eduardo Ribeiro](https://github.com/EduardoRibeiroXavier) |