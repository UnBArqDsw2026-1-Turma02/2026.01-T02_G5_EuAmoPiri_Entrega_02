...
- **UML deployment diagrams overview, common types of deployment diagrams - manifestation diagram, specification and instance level deployment diagram.** Disponível em: <https://www.uml-diagrams.org/deployment-diagrams-overview.html>.
...
| 1.2.2 | 22/04/2026 | Adição de visão de contribuidora e referências utilizadas para o desenvolvimento do diagrama. | [Anna Clara](https://github.com/annacbrandao) | - |
